...
export default function CartPage() {
  ...
  const proceedToCheckout = () => {
    router.push(
      activeOrderId ? `/checkout?orderId=${activeOrderId}` : "/checkout",
    );
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 lg:sticky lg:top-8 border border-gray-100">
      ...
      <div className="relative rounded-2xl border border-white/20 bg-white/10 p-6 backdrop-blur-md mb-18">
